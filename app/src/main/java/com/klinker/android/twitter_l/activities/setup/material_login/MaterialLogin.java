...
public class MaterialLogin extends AppIntro2 {
    ...
    private void addSlides() {
        welcomeFragment = ImageFragment.newInstance(getString(R.string.first_welcome), getString(R.string.first_info), "file:///android_asset/ic_launcher_mobo.png", Color.parseColor("#37acfb"));
